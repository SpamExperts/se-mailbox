...
* ``smaildir.Maildir`` is a Gmail-style Maildir mailbox. It uses scandir() instead of listdir(). It also provides a ew iter_folders() method that works like list_folders(), put provides a generator instead of returning a list.
